...
<head>
    ...
    <!-- Mobile Stuff + CSS -->
    <link rel = "stylesheet" type = "text/css" href = "<?php echo get_template_directory_uri(); ?>/assets/mobile.css?ver=1.02" />
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/assets/icons/favicon.png?ver=1.02"/>
...
<div class = "header_container" id = "top">
    ...
    <div class = "header">
        ...
        <!-- Main nav -->
        <?php wp_nav_menu( array( 'theme_location' => 'primary', 'container' => 'div', 'container_class' => 'main_nav_container', 'menu_class' => 'main_nav' ) ); ?>
